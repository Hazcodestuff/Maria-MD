...
//contact details
global.ownernumber = [ process.env.OWNER_NUMBER || "601157554158"],
global.ownername = process.env.OWNER_NAME || "Dank",
global.ytname = "YT: Dank Memes"
global.socialm = "GitHub: Dank Memes"
global.location = "Malaysian"

global.botname = process.env.BOTNAME || "Dank Memer",//name of the bot

//sticker details
global.stickername = process.env.STICKER || "Memes",
global.packname = 'Memes'
global.author = process.env.AUTHOR || "The Meme Community",
//console view/theme
global.themeemoji = '🧩'
global.wm = "Danks Corp."
